$(function () {
	...
	$(".sparkley").sparkleh({
		color: "rainbow", // color: ["#FFFFFF", "#0000FF", "#CC0000"] // rainbow as a color generates random rainbow colros
		count: 150, // count determines number of sparkles
		speed: 0.5, // speed allows us to control... the ... velocity
